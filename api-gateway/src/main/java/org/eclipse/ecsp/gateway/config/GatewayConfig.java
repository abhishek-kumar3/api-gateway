...
import org.eclipse.ecsp.gateway.plugins.spi.DefaultGatewayErrorResponseBuilder;
...
public class GatewayConfig {
    ...
    /**
     * Default {@link GatewayErrorResponseBuilder} bean — produces the standard
     * {@code {"message":"...", "code":"..."}} error response shape.
     * Overridden by any user-defined {@link GatewayErrorResponseBuilder} bean.
     *
     * @return default error response builder instance
     */
    @Bean
    @ConditionalOnMissingBean(GatewayErrorResponseBuilder.class)
    public GatewayErrorResponseBuilder defaultGatewayErrorResponseBuilder() {
        LOGGER.info("Registering DefaultGatewayErrorResponseBuilder "
                + "(no custom GatewayErrorResponseBuilder bean found).");
        return new DefaultGatewayErrorResponseBuilder();
    }
